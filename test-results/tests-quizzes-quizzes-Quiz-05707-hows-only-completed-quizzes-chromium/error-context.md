...
- Name: tests/quizzes/quizzes.spec.js >> Quiz Dashboard >> filtering by Done shows only completed quizzes
- Location: e2e/tests/quizzes/quizzes.spec.js:75:3
...
Call log:
  - waiting for locator('ul').locator('li').filter({ hasText: /^Done$/ }) to be visible
