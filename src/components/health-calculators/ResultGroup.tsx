...
export default function ResultGroup({
  ...
  const safePercentage = (value: number, base: number) => {
    ...
    <div>
      ...
      <div className='w-full flex flex-col rounded-b-lg border-2 border-secondary-dark-blue pr-7 pl-7 pt-8 pb-5 relative font-content'>
        ...
        {result &&
          ...
          Object.entries(result).map(([labelValue, numericValue], index) => {
            const calorieValue = Number.isNaN(numericValue) ? 0 : numericValue;
