...
interface RadioButtonProps {
  ...
  text?: string;
  showBodyFat?: boolean;
  bodyFatValue?: string | number;
  onBodyFatChange?: (event: ChangeEvent<HTMLInputElement>) => void;
}
                ...
                >
                  <div className='flex items-center'>
                    <input
                      ...
                      checked={value === (typeof choice === 'string' ? choice : choice.value)}
                      onChange={() => handleChange(typeof choice === 'string' ? choice : choice.value)}
