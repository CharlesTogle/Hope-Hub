        ...
        <div id='video-details' className={`mt-5 mb-20 px-3`}>
          ...
          {video.description.do && video.description.do.length > 0 && (
            <div>
              ...
              <ul className='mb-4'>
                {video.description.do.map((doItem) => (
                  <li key={doItem} className='flex items-start mb-1'>
          ...
          {video.description.dont && video.description.dont.length > 0 && (
            <div>
              ...
              <ul className='lg:mb-4'>
                {video.description.dont.map((dontItem) => (
                  <li key={dontItem} className='flex items-start mb-1'>
