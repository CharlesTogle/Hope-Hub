...
import type { Reference } from '@/types/workout';
...
export default function Citation({ title, citations }: CitationProps) {
  return (
        ...
        <AccordionItem value='references'>
          ...
          <AccordionContent>
            {citations.map((citation) => (
              <div className='mb-2 text-wrap text-justify' key={citation.link}>
                <div>
                  {citation.name}
                  <a
                    href={citation.link}
