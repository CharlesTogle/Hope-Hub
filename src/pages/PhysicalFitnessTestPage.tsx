...
export function PhysicalFitnessTestPage() {
  ...
  useEffect(() => {
    ...
    if (serverSession) setSessionData(serverSession);
    else clearSessionData();
  }, [clearSessionData, isTeacher, pftFetching, pftRecord, pftStatus, setSessionData]);
  ...
  if (pftLoading || pftFetching || classLoading || !userId) {
    return <Loading />;
  }
